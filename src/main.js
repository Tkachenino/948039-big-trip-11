...
const createFormEditorTamplate = () => {
  return (
    `
...
render(siteBoardEvents, createPointsSortElement());
render(siteBoardEvents, createFormEditorTamplate());
